...
var newArrayAfterDeleting = function (id) {
    var idElemToDelete = tasksArray.findIndex(function (element) { return element.id === id; });
    console.log('id to delete: ', idElemToDelete);
    var newTasksArray = tasksArray.splice(idElemToDelete, 1);
